...
export default function Home() {
    return (
        <>
            <h1 className="text-2xl sm:text-3xl font-semibold"> Home | ASTCAW </h1>
            <h1 className="text-xl sm:text-2xl mt-6"> Proper Waste Disposal </h1>
            ...
            <section className="mt-6 text-justify">
                <HeaderTitle to="impact" className="text-xl sm:text-2xl font-semibold"> Impact </HeaderTitle>
                <p className="mt-4">
