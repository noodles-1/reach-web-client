...
const FAQs = () => {
    return (
        <div>
            <h1 className="text-3xl font-semibold"> Dashboard User Guide and FAQs </h1>
            <section className="mt-6">
                <HeaderTitle to="guide" className="text-2xl"> Step-by-step guide on how to use the dashboard: </HeaderTitle>
                <ol className="list-inside list-decimal mt-6">
                    <li className="mb-6"> 
                        <span className="font-semibold text-2xl"> Open the web browser </span>
                        <p className="mt-2"> 
                            Launch your preferred web browser and enter the website URL into the address bar. Press Enter to access the website.
                        </p>
                    </li>
                    <li className="mb-6"> 
                        <span className="font-semibold text-2xl"> Access the dashboard </span>
                        <p className="mt-2"> 
                            Locate the dashboard link or tab in the website's main menu. Click on it to open the dashboard.
                        </p>
                    </li>
                    <li className="mb-6"> 
                        <span className="font-semibold text-2xl"> Familiarize with the layout </span>
                        <p className="mt-2"> 
                    ...
                    <li className="mb-6"> 
                        <span className="font-semibold text-2xl"> Explore features </span>
                        <p className="mt-2"> 
            ...
            <section className="mt-6">
                <HeaderTitle to="questions" className="text-2xl"> Common questions regarding the data and its interpretation: </HeaderTitle>
                <h1 className="text-2xl font-semibold mt-6"> What does the total waste count represent? </h1>
                ...
                <h1 className="text-2xl font-semibold mt-6"> Why does the chart sometimes show zero or empty data? </h1>
                ...
                <h1 className="text-2xl font-semibold mt-6"> How are the recycling trends tracked? </h1>
            ...
            <Separator className="my-4" />
            <section className="mt-6">
                <HeaderTitle to="issues" className="text-2xl"> Tehnical issues </HeaderTitle>
                <h1 className="text-2xl font-semibold mt-6"> Camera cannot detect trash </h1>
                <p className="mt-4"> 
                ...
                <h1 className="text-2xl font-semibold mt-6"> Data not displaying properly </h1>
                <p className="mt-4"> 
                    <strong> Solution: </strong> 
                ...
                <h1 className="text-2xl font-semibold mt-6"> Issues with the trash collector data </h1>
                <p className="mt-4"> 
                    <strong> Solution: </strong> 
